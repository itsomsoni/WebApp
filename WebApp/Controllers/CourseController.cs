...
namespace WebApp.Controllers
{
    public class CourseController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CourseId,CourseName,CourseDescription")] CourseModel courseModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CourseId,CourseName,CourseDescription,SysDate")] CourseModel courseModel)
        {
